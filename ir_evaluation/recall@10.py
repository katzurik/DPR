...
def recall(relevant_paragraphs, retrieved_paragraphs):
    retrieved_paragraphs = [paragraph.split('strategyqa:', 1)[1] for paragraph in retrieved_paragraphs]
...
def calculate_score(args):
    ...
    for json_obj in dataset:
        ...
        retrieved_paragraphs = all_retrieved_paragraphs[json_obj["qid"]]['paragraphs'][: args.retrieval_limit]
