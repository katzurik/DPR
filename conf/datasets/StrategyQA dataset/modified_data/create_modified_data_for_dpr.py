...
path = '/Users/uri/Documents/Uri/school/Thesis/Implicit/thesis/DPR/conf/datasets/StrategyQA dataset/gold/strategyQA_dev.json'
...
#
#
# output_file = 'gold/strategyQA_'+datatype+'__USE_EVAL_ONLY.json'
# with open(output_file,"w") as fd:
#         json.dump(data, fd)